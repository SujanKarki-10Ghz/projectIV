                            ...
                            <div class="shopping-cart">
                                            ...
                                            @foreach ($cart_data as $data)
                                                <tr class="cartpage">
                                                    ...
                                                    <td style="font-size: 20px;">
                                                        <button type="button" class="badge badge-danger delete_cart_data"><li class="fa fa-trash-o"></li> Delete</button>
                                                    </td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12 ">
                                        <div id="totalajaxcall" class="card card-body mt-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="cart-checkout-btn text-center">
                                                        @if (Auth::user())
                                                            <a href="{{ url('checkout') }}" class="btn btn-success btn-block checkout-btn">
